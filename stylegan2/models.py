...
def get_generator(dataset, args):
    ...
    if dataset == "shapes3d":
        generator.load_state_dict(torch.load("./generators/3dshapes/%01d.pt" % args.index))
    elif dataset == "noisy":
        generator.load_state_dict(torch.load("./generators/noisy/%01d.pt" % args.index)['g_ema'])
    elif dataset == "color":
        generator.load_state_dict(torch.load("./generators/color/%01d.pt" % args.index)['g_ema'])
    elif dataset == "scream":
        generator.load_state_dict(torch.load("./generators/scream/%01d.pt" % args.index)['g_ema'])
    elif dataset == "mpi3d":
        generator.load_state_dict(torch.load("./generators/mpi3d/%01d.pt" % args.index))
    elif dataset == "isaac":
        generator.load_state_dict(torch.load("./generators/isaac3d/generator.pt"))
    elif dataset == "cars3d":
        generator.load_state_dict(torch.load("./generators/cars/%01d.pt" % args.index))
    elif dataset == "ffhq":
        generator.load_state_dict(torch.load("./generators/ffhq/generator.pt")['g_ema'])
    elif dataset == "ffhq_low":
        generator.load_state_dict(torch.load("./generators/convert_ffhq_256_config-e.pt")["g_ema"])
    elif dataset == "cat":
        generator.load_state_dict(torch.load("./generators/convert_cat_256_config-f.pt")["g_ema"])
    elif dataset == "church":
        generator.load_state_dict(torch.load("./generators/convert_church_256_config-f.pt")["g_ema"])
    elif dataset == "car":
        generator.load_state_dict(torch.load("./generators/convert_car_512_config-f.pt")["g_ema"])
    else:
